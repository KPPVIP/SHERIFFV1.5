...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
			...
			{label = '<span style="color:#0B80F4;"> Poser/Récupérer votre radar<span style="color:cyan;">', value = 'radar'},
			{label = '<span style="color:#0B80F4;"> Menu Prison<span style="color:cyan;">', value = 'jail'}
	}}, function(data, menu)
  ...
  while true do
    ...
    --if IsJobTrue() then
        ...
        if IsControlJustReleased(0, Keys["E"]) and isInPublicMarker then
          TriggerEvent('police:teleportMarkers', position)
        end
