Locales['fr'] = {
  ...
  -- Action Menu
  ['citizen_interaction'] = '<span style="color:#0BF4B8;"> interaction citoyen<span style="color:cyan;">',
  ['vehicle_interaction'] = '<span style="color:#F4C60B;"> interaction véhicule<span style="color:cyan;">',
  ['object_spawner'] = '<span style="color:#0BF427;"> placer objets<span style="color:cyan;">',
