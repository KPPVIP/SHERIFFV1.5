...
Config.PoliceStations = {
	...
	LSPD = {
		...
		Cloakrooms = {
			vector3(-436.27, 5989.67, 31.71),
			vector3(-473.76, 5984.41, 31.42)
		},

		Armories = {
			vector3(-437.95, 5988.56, 31.71),
		...
		Helicopters = {
			{
				...
				InsideShop = vector3(-363.0073, 6072.501, 30.4982),
				SpawnPoints = {
					{ coords = vector3(-477.49, 5989.24, 37.38), heading = 47.09, radius = 10.0 }
				}
			}
		},

		BossActions = {
			vector3(-435.83, 6000.08, 31.71),
			vector3(-489.55, 5985.51, 31.42)
		}
